                        ...
                        <div className="p-8">
                            ...
                            {activeTab === 'login' && (
                                <form className="space-y-5" onSubmit={handleLogin}>
                                    ...
                                    <div className="flex items-center justify-between text-xs py-1">
                                        ...
                                        <a className="text-primary hover:text-accent-blue font-bold" href="#">Forgot Password?</a>
                                    </div>
                                    <button
                                        disabled={loading}
                                    ...
                                    <button 
                                        ...
                                        className="w-full bg-white text-slate-950 font-bold py-3 rounded-lg transition-all hover:bg-slate-100 flex items-center justify-center gap-3 cursor-pointer" type="button"
                                    >
                            ...
                            {activeTab === 'signup' && (
                                <form className="space-y-5" onSubmit={handleSignup}>
                                    ...
                                    <button
                                        className="w-full bg-white text-slate-950 font-bold py-3 rounded-lg flex items-center justify-center gap-3 cursor-pointer" type="button"
                                        onClick={handleGoogleLogin}
                                    >
                                        <svg className="w-5 h-5" viewBox="0 0 24 24">
                                            <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="currentColor"></path>
